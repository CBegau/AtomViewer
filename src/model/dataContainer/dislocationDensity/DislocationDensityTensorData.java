...
//	private DislocationDensityTensor plasticZone;
	...
	public static class JDislocationDensityTensorControls extends JDataPanel {
		...
		private JDislocationDensityTensorControls(DislocationDensityTensorData ddtd, AtomData data) {
			...
			axisComboBox.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent arg0) {
					...
					renderStartSlice = 0;
					renderEndSlice = JDislocationDensityTensorControls.this.ddtd.gridSize[selected];
									
					lowerLimitTextBox.setValue(0);
					upperLimitTextBox.setValue(JDislocationDensityTensorControls.this.ddtd.gridSize[selected]);
					viewer.reDraw();
				}
			});
		...
		public void setDDTData(DislocationDensityTensorData ddtd){
			this.ddtd = ddtd;
		}
...
//		}
	...
	public boolean showOptionsDialog() {
		try {
			gridSize[0] = Integer.parseInt(JOptionPane.showInputDialog("How many slices for the dislocation density in x-direction?", 10));
			gridSize[1] = Integer.parseInt(JOptionPane.showInputDialog("How many slices for the dislocation density in y-direction?", 10));
			gridSize[2] = Integer.parseInt(JOptionPane.showInputDialog("How many slices for the dislocation density in z-direction?", 10));
