...
import static delaunay.V.A;
import static delaunay.V.B;
import static delaunay.V.C;
import static delaunay.V.D;
import static delaunay.Geometry.centerSphere;
...
public class Tetrahedron implements Iterable<OrientedFace> {
     ...
     * @param faces
     */
    public void addFacesCoordinates(List<Vec3[]> faces) {
        faces.add(new Vec3[] { a.asVec3(), d.asVec3(), b.asVec3() });
        faces.add(new Vec3[] { b.asVec3(), c.asVec3(), a.asVec3() });
        faces.add(new Vec3[] { c.asVec3(), b.asVec3(), d.asVec3() });
        faces.add(new Vec3[] { d.asVec3(), a.asVec3(), c.asVec3() });
    }
    ...
    void traverseVoronoiFace(Tetrahedron origin, Tetrahedron from, Vertex vC,
        ...
        centerSphere(a.x, a.y, a.z, b.x, b.y, b.z, c.x, c.y, c.z, d.x, d.y,
                     d.z, center);
        face.add(new Vec3((float) center[0], (float) center[1],
                             (float) center[2]));
     ...
     * @param face
     */
    void traverseVoronoiFace(Vertex vC, Vertex axis, List<Vec3[]> faces) {
        ArrayList<Vec3> face = new ArrayList<Vec3>();
        double[] center = new double[3];
        centerSphere(a.x, a.y, a.z, b.x, b.y, b.z, c.x, c.y, c.z, d.x, d.y,
                     d.z, center);
        face.add(new Vec3((float) center[0], (float) center[1],
        ...
        faces.add(face.toArray(new Vec3[face.size()]));
    }
